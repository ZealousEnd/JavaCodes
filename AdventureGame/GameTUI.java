...
public class GameTUI
{
    ...
    public void start() {
        // Initialize any necessary components or display a welcome screen
        StdDraw.drawText("Welcome to the Adventure Game!");
        StdDraw.drawText("Press any key to start...");
        StdIn.readString(); // Wait for the user to press a key

        run(); // Start the main game loop after setup or welcome message
    }

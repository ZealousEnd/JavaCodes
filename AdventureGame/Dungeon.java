...
public class Dungeon implements Serializable
{
    ...
    private void loadGame() {
        try (ObjectInputStream in = new ObjectInputStream(new FileInputStream("SavedGame.dat"))) {
            ...
            // Update current dungeon state with loaded state
            this.config = loadedDungeon.config;
            this.width = loadedDungeon.width;
            this.height = loadedDungeon.height;
            this.hero = loadedDungeon.hero;
            this.map = loadedDungeon.map;
            this.monsters = loadedDungeon.monsters;
